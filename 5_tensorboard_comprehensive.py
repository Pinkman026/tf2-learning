# code from: https://www.cnblogs.com/nickchen121/p/10921820.html
...
data_loader = data_loader.map(preprocess).shuffle(60000).batch(batch_size).repeat(10)
...
# get x from (x,y)
sample_img = next(iter(data_loader))[0]
